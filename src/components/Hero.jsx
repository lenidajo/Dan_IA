  ...
  return (
    <section style={{ position: 'relative', overflow: 'hidden', background: '#0A1628' }}>
      ...
      <div style={{
        ...
        display: 'grid', gridTemplateColumns: '1fr 420px', gap: '3rem',
        alignItems: 'center', position: 'relative'
      }}>
        {/* LEFT */}
        <div>
          <div style={{
            display: 'inline-block', background: 'rgba(30,136,229,0.12)',
            border: '1px solid rgba(30,136,229,0.35)', color: '#90CAF9',
            padding: '0.3rem 1rem', borderRadius: 20, fontSize: '0.72rem',
            fontWeight: 500, marginBottom: '1.2rem', letterSpacing: '0.5px'
          }}>
          ...
          <p style={{ color: '#94A3B8', fontSize: '1rem', lineHeight: 1.7, marginBottom: '1.5rem', maxWidth: 480 }}>
            De usuario intermedio a experto en Business Intelligence.
            Power Query, Power Pivot, DAX y Big Data — todo en Excel.
          </p>

          {/* Precio */}
          <div style={{ marginBottom: '1.8rem', display: 'flex', alignItems: 'baseline', gap: '0.6rem' }}>
            <span style={{ color: '#64748B', textDecoration: 'line-through', fontSize: '0.9rem' }}>
              ${fmt(PRECIO.anterior)} COP
            </span>
            <span className="montserrat" style={{ fontSize: '2.4rem', fontWeight: 900, color: '#1E88E5' }}>
              ${fmt(PRECIO.actual)}
            </span>
          ...
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '2.5rem' }}>
            ...
            <button className="btn-primary"
              ...
              style={{ fontSize: '1rem', padding: '0.9rem 2rem', background: 'transparent', border: '1px solid rgba(30,136,229,0.4)', color: '#90CAF9' }}>
        ...
        <div style={{ position: 'relative', display: 'flex', justifyContent: 'center' }}>
          ...
          <img
            src="/assets/dan1.png"
            alt="DanExcel - Automatiza, Analiza, Crece"
            style={{
